source_dir="/private7/projects/beta_cells/human_A_B/barcode_files/inputHE_human_A_B.txt"

genome_bwa_ind="/private/common/Data/Genomes/Human/hg19.bwa_index/hg19"
genome_trans_bwa_ind="/private/common/Data/Genomes/Human/hg19-transformed.bwa_index/hg19"
...
dir_pre="/private7/projects/beta_cells/human_A_B/HE" #output directory that will be created  
...
run_ue_script="/home/alu/ilanas/Scripts/config/run_hyper_editing_hg19_withStat.sh"  #################
